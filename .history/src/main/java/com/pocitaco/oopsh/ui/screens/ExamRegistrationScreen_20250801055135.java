...
public class ExamRegistrationScreen extends BorderPane {
    ...
    private VBox createFiltersSection() {
        ...
        filtersSection.setStyle("-fx-background-color: " + MaterialDesignManager.Colors.SURFACE_VARIANT + "; -fx-background-radius: 8;");
    ...
    private VBox createTableSection() {
        ...
        tableSection.setStyle("-fx-background-color: " + MaterialDesignManager.Colors.SURFACE + "; -fx-background-radius: 8;");
    ...
    private TableView<ExamSchedule> createAvailableExamsTable() {
        ...
        dateCol.setCellValueFactory(cellData -> {
            ...
            return new SimpleStringProperty(dateValue != null ? 
                    dateValue.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "N/A");
        });
    ...
    private VBox createMyRegistrationsContent() {
        ...
        tableContainer.setStyle("-fx-background-color: " + MaterialDesignManager.Colors.SURFACE + "; -fx-background-radius: 8;");
    ...
    private void applyFilters() {
        try {
            ...
            List<ExamSchedule> filteredSchedules = allSchedules.stream()
                    ...
                    .filter(schedule -> {
                        // Status filter
                        if (selectedStatus == null || "All".equals(selectedStatus)) return true;
                        boolean isRegistered = isAlreadyRegistered(schedule);
                        if ("Available".equals(selectedStatus)) return !isRegistered;
                        if ("Registered".equals(selectedStatus)) return isRegistered;
                        return true;
                    })
                    .collect(Collectors.toList());
        ...
        confirmation.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                try {
                    ...
                    showSuccess("Registration successful! You can view your registration in the 'My Registrations' tab.");
                } catch (Exception e) {
