...
public class ExamRegistrationScreen extends BorderPane {
    ...
    private void navigateToDashboard() {
        try {
            ...
            navigationManager.setCurrentUser(currentUser);
            navigationManager.navigateToCandidateDashboard();
    ...
    private void openPracticeTests() {
        try {
            ...
            navigationManager.setCurrentUser(currentUser);
            navigationManager.navigateToPracticeTests();
    ...
    private void openExamResults() {
        try {
            ...
            navigationManager.setCurrentUser(currentUser);
            navigationManager.navigateToExamResults();
    ...
    private void openStudyMaterials() {
        try {
            ...
            navigationManager.setCurrentUser(currentUser);
            navigationManager.navigateToStudyMaterials();
