...
### **Fix SessionReportDAO XML Parsing Error** ✅

- [x] Identify XML structure mismatch in session_reports.xml
- [x] Fix XML file to match SessionReport model structure
- [x] Add safe field handling in SessionReportDAO.elementToEntity()
- [x] Handle missing optional fields gracefully
- [x] Test Examiner login without XML parsing errors

### **Fix DAO File Path Issues** ✅

- [x] Identify NullPointerException in BaseDAO.initializeXMLFile()
- [x] Fix SessionReportDAO to use correct file path "data/session_reports.xml"
- [x] Fix StudyMaterialDAO to use correct file path "data/study_materials.xml"
- [x] Fix CertificateDAO to use correct file path "data/certificates.xml"
- [x] Ensure all DAOs use proper "data/" prefix for file paths
- [x] Test login with all user roles without file path errors
